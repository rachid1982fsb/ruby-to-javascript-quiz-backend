...
Source.create(name: "kangaroo", ruby_method: "https://memorycardgame.s3.amazonaws.com/images/Screen%20Shot%202020-01-19%20at%2010.35.45%20PM.png",
 ...
 For example, kangaroo 1 starts at X1 = 2 with a jump distance  V1 = 1 and kangaroo 2 starts at X2 = 1 with a jump distance V2 = 2 of . After one jump, they are both at X = 3, (X1 + V1 = 2 + 1, X2 + V2 = 1+ 2 ), so our answer is YES.")
    TestCase.create(source_id: 3, input: "0,2,5,3", output: "NO")
    TestCase.create(source_id: 3, input: "0,3,4,2", output: "YES")
    TestCase.create(source_id: 3, input: "14,4,98,2", output: "YES")
    TestCase.create(source_id: 3, input: "28,8,96,2", output: "NO")


Source.create(name: "miniMaxSum", ruby_method: "https://memorycardgame.s3.amazonaws.com/images/Screen%20Shot%202020-01-19%20at%2012.48.23%20PM.png",
...
arr: an array of 5 integers")
    TestCase.create(source_id: 4, input: "[1,2,3,4,5]", output: "10 14")
    TestCase.create(source_id: 4, input: "[256741038,623958417,467905213,714532089,938071625]", output: "2063136757 2744467344")
    TestCase.create(source_id: 4, input: "[156873294,719583602,581240736,605827319,895647130]", output: "2063524951 2802298787")
    TestCase.create(source_id: 4, input: "426980153,354802167,142980735,968217435,734892650", output: "1659655705 2484892405")


Source.create(name: "getMoneySpent", ruby_method: "https://memorycardgame.s3.amazonaws.com/images/Screen%20Shot%202020-01-19%20at%203.00.36%20PM.png",
